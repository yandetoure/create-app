<x-dashboard-layout>
    <x-slot name="title">Nouvelle Fonctionnalité de Base</x-slot>
    ...
    <div class="max-w-3xl">
        ...
        <div class="bg-white/5 border border-white/10 rounded-[3rem] p-10 shadow-2xl backdrop-blur-md">
            <h3 class="text-2xl font-black mb-8">Créer une Fonctionnalité de Base</h3>

            <form action="{{ route('admin.core-features.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                        ...
                        placeholder="Ex: Lien GitHub, Nom de domaine, Hébergement..." required>
                    @error('name')
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="4"
                        ...
                        placeholder="Description détaillée de cette fonctionnalité...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
