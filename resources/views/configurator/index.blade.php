<x-app-layout>
    <div class="min-h-screen bg-[#020617] text-white font-['Outfit'] antialiased overflow-x-hidden"
        x-data="configurator()">
        ...
        <div
            class="fixed bottom-0 left-0 w-[300px] h-[300px] bg-indigo-500/5 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/4 pointer-events-none">
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p class="text-gray-400">Étape <span x-text="step" class="text-indigo-400 font-bold"></span> sur 4
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start text-base">
                ...
                <div class="lg:col-span-2">
                    <form id="configForm" action="{{ route('configurator.store') }}" method="POST">
                        ...
                        <div x-show="step === 1" x-transition:enter="transition ease-out duration-300 transform"
                            ...
                            <div
                                class="bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] shadow-2xl">
                                <h3 class="text-3xl font-bold mb-8 flex items-center">
                                    <span
                                        class="w-12 h-12 rounded-2xl bg-indigo-600/20 text-indigo-400 flex items-center justify-center mr-4 text-xl">01</span>
                                    Quel est le nom du projet ?
                                </h3>
                                <div class="space-y-4">
                                    <label
                                        class="text-sm font-bold text-gray-500 uppercase tracking-widest pl-1">Identité</label>
                                ...
                                <div class="mt-12 flex justify-end">
                                    <button type="button" @click="if(projectName) step = 2"
                                        ...
                                        Continuer
                                        <svg class="ml-2 w-5 h-5 group-hover:translate-x-1 transition" fill="none"
                        ...
                        <div x-show="step === 2" x-transition:enter="transition ease-out duration-300 transform"
                            ...
                            <div
                                ...
                                <h3 class="text-3xl font-bold mb-8 flex items-center">
                                    <span
                                        class="w-12 h-12 rounded-2xl bg-indigo-600/20 text-indigo-400 flex items-center justify-center mr-4 text-xl">02</span>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                    @foreach($categories as $category)
                                        <div @click="selectCategory({{ json_encode($category) }})"
                                            ...
                                            <div
                                                class="text-5xl mb-6 transform group-hover:scale-110 transition duration-500">
                                            ...
                                            <div x-show="selectedCategory?.id === {{ $category->id }}"
                                ...
                                <div class="mt-12 flex justify-between">
                                    <button type="button" @click="step = 1"
                                        class="text-gray-500 font-bold px-8 hover:text-white transition">←
                                        Retour</button>
                        ...
                        <div x-show="step === 3" x-transition:enter="transition ease-out duration-300 transform"
                            ...
                            <div
                                ...
                                <h3 class="text-3xl font-bold mb-8 flex items-center">
                                    <span
                                        class="w-12 h-12 rounded-2xl bg-indigo-600/20 text-indigo-400 flex items-center justify-center mr-4 text-xl">03</span>
                                    Détails du projet
                                </h3>
                                            ...
                                            <div @click="selectType(type)"
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-sm text-gray-500"
                                                        x-text="'Dès ' + type.base_price + ' FCFA • ±' + type.base_duration_days + ' jours'">
                                                    </div>
                                                </div>
                        ...
                        <div x-show="step === 4" x-transition:enter="transition ease-out duration-300 transform"
                            ...
                            <div
                                ...
                                <h3 class="text-3xl font-bold mb-4 flex items-center">
                                    <span
                                        class="w-12 h-12 rounded-2xl bg-indigo-600/20 text-indigo-400 flex items-center justify-center mr-4 text-xl">04</span>
                                    Modules & Options
                                </h3>
                                <p class="text-gray-500 mb-10">Personnalisez votre projet avec des fonctionnalités
                                    premium.</p>

                                <!-- Platforms -->
                                <div class="mb-12">
                                    <h4 class="text-xs font-bold uppercase tracking-widest text-indigo-400 mb-6">
                                        Multi-Plateforme</h4>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <label x-show="selectedCategory?.slug !== 'app-mobile'"
                                            ...
                                            <input type="checkbox" value="mobile" x-model="platforms"
                                            ...
                                            <div class="text-indigo-400 font-bold">+<span
                                                    x-text="Math.round(selectedType?.base_price * 0.4)"></span> FCFA
                                            </div>
                                        </label>
                                        <label x-show="selectedCategory?.slug !== 'site-web'"
                                            ...
                                            <input type="checkbox" value="web" x-model="platforms"
                                                @change="updatePrice()" class="sr-only">
                                            <div class="flex-1">
                                            ...
                                            <div class="text-indigo-400 font-bold">+<span
                                                    x-text="Math.round(selectedType?.base_price * 0.35)"></span> FCFA
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                            @foreach($fCat->features as $feature)
                                                <label
                                                    ...
                                                    <input type="checkbox" @change="toggleFeature({{ json_encode($feature) }})"
                                                        class="sr-only">
                                                    <div class="flex-1">
                                                        <div class="font-bold">{{ $feature->name }}</div>
                                                        <div class="text-xs text-gray-500 mt-1">{{ $feature->description }}
                                                        </div>
                                                    </div>
                                                    <div class="text-right">
                                                        <div class="text-indigo-400 font-bold">+{{ round($feature->price) }}
                                                            FCFA</div>
                                                        <div class="text-[10px] text-gray-500">+{{ $feature->impact_days }}j
                                                        </div>
                                                    </div>
                                                </label>
                                            @endforeach
                ...
                <aside class="lg:sticky lg:top-24 space-y-6">
                    <div
                        class="bg-indigo-600 rounded-[2.5rem] p-10 text-white shadow-2xl overflow-hidden relative group">
                        <!-- Design dots -->
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="pt-6 border-t border-white/10 space-y-4">
                                    ...
                                    <div class="pt-4 flex flex-col">
                                        <p class="text-[10px] font-bold uppercase text-white/40 mb-1">Montant Total HT
                                        </p>
                                        <p class="text-6xl font-black tracking-tighter" x-text="totalPrice + ' FCFA'">
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="pt-6 grid grid-cols-2 gap-4">
                                    <div class="bg-black/20 rounded-2xl p-4">
                                        ...
                                        <p class="font-bold" x-text="(totalPrice * 0.4).toFixed(0) + ' FCFA'"></p>
                                    </div>
                                    <div class="bg-black/20 rounded-2xl p-4">
                                        <p class="text-[9px] text-white/30 uppercase font-black">Solde (60%)</p>
                                        <p class="font-bold" x-text="(totalPrice * 0.6).toFixed(0) + ' FCFA'"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hidden md:block">
                        <div class="flex items-start space-x-4">
                            ...
                            <p class="text-sm text-gray-400">Chaque option est modifiable ultérieurement avec votre
                                conseiller dédié.</p>
                        </div>
                    </div>
                </aside>
