...
class CategorySeeder extends Seeder
{
    ...
    {
        $webSite = Category::create(['name' => 'Site Web Vitrine / Corporate', 'slug' => 'site-web', 'icon' => 'globe-alt']);
        $mobileApp = Category::create(['name' => 'Application Mobile Native/Hybride', 'slug' => 'app-mobile', 'icon' => 'device-phone-mobile']);
        $webApp = Category::create(['name' => 'Logiciel Métier / SaaS', 'slug' => 'web-app', 'icon' => 'computer-desktop']);
